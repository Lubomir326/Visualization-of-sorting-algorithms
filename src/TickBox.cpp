...
TickBox::TickBox()
{
	...
	if (!TickBoxTexture1.loadFromFile(std::string(RESOURCES) + "Textures/TickBoxFalse.png"))
		throw "cannot load image";
	if (!TickBoxTexture2.loadFromFile(std::string(RESOURCES) + "Textures/TickBoxTrue.png"))
		throw "cannot load image";
